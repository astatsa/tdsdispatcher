...
namespace TDSDispatcher.Views
{
    ...
    {
        private bool firstColumnGenerated = true;
        private bool firstColumnDeleted;
        ...
        private void DataGrid_AutoGeneratingColumn(object sender, DataGridAutoGeneratingColumnEventArgs e)
        {
            ...
            if (!firstColumnGenerated && dg.Columns.Count > 0 && !firstColumnDeleted)
            {
                dg.Columns.Clear();
                firstColumnDeleted = true;
            }
